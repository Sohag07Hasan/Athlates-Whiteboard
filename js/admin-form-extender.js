...
jQuery(document).ready(function($){
	...
	$('span.add-component').live('click', function(){		
		...
		var empty_component = '<tr><td>Component </td><td><input type="text" recname="componentname1" name="component-names[]" value="" /></td>	<td><textarea rows="2" cols="50" recname="componentdes1" name="component-descriptions[]"></textarea></td><td class="add-remove-action"> <span class="remove-component">Remove</span></td></tr>';
