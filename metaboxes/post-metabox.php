	 ...
	 <div class="athlates-white-board-parent-class" id="athlates-white-board-parent-id">
		...
		<table>
			<tr>
				...
				<td><textarea rows="5" cols="60" recname="componentdes1" name="ahtlates-white-board-component-descriptions-1[]"></textarea></td>
			</tr>
			<tr>
				<td>Component 2</td>
				<td><input type="text" recname="componentname2" name="ahtlates-white-board-component-names-2[]" ></td>
				<td><textarea rows="5" recname="componentdes2" cols="60" name="ahtlates-white-board-component-descriptions-2[]"></textarea></td>
			</tr>
			<tr>
				<td>Component 3</td>
				<td><input type="text" recname="componentname3" name="ahtlates-white-board-component-names-3[]" ></td>
				<td><textarea rows="5" recname="componentdes3" cols="60" name="ahtlates-white-board-component-descriptions-3[]"></textarea></td>
			</tr>
		</table>
