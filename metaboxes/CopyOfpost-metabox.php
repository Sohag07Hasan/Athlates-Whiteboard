...
<div class='wrap'>
	...
	?>
			 ...
			 <div class="athlates-white-board-parent-class">
			 	<p class="board-class-name"> Class Name <input size="50" type="text" recname="cllassname" name="class-names[$key]" value="<?php echo $data['class']; ?>" ></p>
					...
					<?php 
						if($data['component']){
							foreach($data['component'] as $k => $component){
								...
								<tr>
									<td>Component </td>
									<td><input type="text" recname="componentname1" name="component-names[$key][]" value="<?php echo $component['name'] ?>" /></td>
