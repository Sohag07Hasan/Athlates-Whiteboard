									...
									<div class="component-holder">
										...
										<table>
											...
											<tr>
												...
												<td>
													<input name="result[<?php echo $b_data['class']; ?>][<?php echo $component['name']; ?>]" type="text" placeholder="what is athlete's result?" value="<?php echo $result; ?>" >
												</td>
											</tr>
											...
											<tr>
												<th scope="row">Rx</th>
												<td>
													<input <?php checked($Rx); ?>  name="Rx[<?php echo $b_data['class']; ?>][<?php echo $component['name']; ?>]" type="checkbox" value="on" />
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													<input name="RxScale[<?php echo $b_data['class']; ?>][<?php echo $component['name']; ?>]" type="text" placeholder="How do you scale?" value="<?php echo $RxScale; ?>" />
												</td>
											</tr>
